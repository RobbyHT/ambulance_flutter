...
import 'components/longbtn.dart';
import 'components/shortbtn.dart';
        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            children: <Widget>[
              ...
              Center(
                child: Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        border: Border.all(
                            color: Color.fromRGBO(155, 164, 180, 1), width: 3)),
              ...
              SizedBox(width: 10, height: 10),
              LongWidget(
                  inputText: '生理食鹽水(500ml)', day: '2021/08/31', number: '1'),
              SizedBox(width: 10, height: 10),
              ...
              SizedBox(width: 10, height: 10),
              LongWidget(
                  inputText: '口呼吸道(含各大小型5種以上)', day: '2021/08/31', number: '1'),
              SizedBox(width: 10, height: 10),
              //鼻咽呼吸道
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
              ...
              SizedBox(width: 10, height: 10),
              LongWidget(
                  inputText: '瞳孔筆及其備用電源', day: '2021/08/31', number: '1'),
              SizedBox(width: 10, height: 10),
              LongWidget(
                  inputText: '驅血帶(靜脈注射用)', day: '2021/08/31', number: '1'),
              SizedBox(width: 10, height: 10),
