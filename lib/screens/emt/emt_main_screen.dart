...
class EmtMainScreen extends StatefulWidget {
  EmtMainScreen({Key key, this.page}) : super(key: key);
  final int page;

  @override
  _EmtMainScreenState createState() => _EmtMainScreenState();
}

class _EmtMainScreenState extends State<EmtMainScreen> {
